...
namespace Holiday.Test
{
    ...
    public class UnitTest1
    {
        ...
        public void Customer1()
        {
            ...
            Console.WriteLine("Flight: " +customer1.Item1.id);
            Console.WriteLine("Hotel: " +customer1.Item2.id);
        ...
        public void Customer2()
        {
            ...
            Console.WriteLine("Flight:  " +customer2.Item1.id);
            Console.WriteLine("Hotel:  " +customer2.Item2.id);
        ...
        public void Customer3()
        {
            ...
            Console.WriteLine("Flight: " +customer3.Item1.id);
            Console.WriteLine("Hotel: " +customer3.Item2.id);
